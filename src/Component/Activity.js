...
const Activity = () => {
    ...
    return (
        <>
            ...
            <div className="row m-0 px-md-3 px-lg-5 px-sm-2 pb-0 pt-0 w-100">
                <div className="card border-0 px-md-2 px-lg-5 px-sm-3">
                    <Carousel className="w-75 mx-auto" data-bs-theme="dark" pause={"hover"}>
                        <Carousel.Item interval={1000}>
                            <img src={tVid} className="card-img-top bg-gradient-info" alt="image traitement de son et video" />
                        ...
                        <Carousel.Item interval={1000}>
                          <img src={tdonne} className="card-img-top bg-gradient-info"  alt="image traitement de donnée" />
                          <Carousel.Caption className="bg-edit border rounded-2 opacity-75">
                        ...
                        <Carousel.Item interval={1000}>
                          <img src={tImg} className="card-img-top bg-gradient-info" alt="image traitement d'image" />
                          <Carousel.Caption className="bg-edit border rounded-2 opacity-75">
