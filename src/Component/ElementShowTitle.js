...
const ElementShowTitle = ({title}) => {
    ...
    return(
        <>
            ...
            {/*<div ref={elementRef} className={`col-md-10 col-sm-11 bg-primary pt-5  pb-3  color-aris ${isVisible ? 'arrow-div' : 'd-none'}`}>*/}
            {/*    <h2 className="text-center fs-2 text-uppercase ">{title}</h2>*/}
            {/*</div>*/}
            <div ref={elementRef} className={`col-md-12 col-sm-11 color-aris ${isVisible ? 'arrow-div' : 'd-none'}`}>
                <div className="row w-100 p-0">
                    <div className="col w-100 px-0">
                        <div className="row m-0 p-0 w-100">
                            <div className="col-6 px-0 pt-5 pb-3 bg-gradient-info-dark block-initial"/>
                            <div className="col-6">
                                <div className=" row m-0 p-0 w-100">
                    ...
                    <div className="col w-100 bg-aris">
