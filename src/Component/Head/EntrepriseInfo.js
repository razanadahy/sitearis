                        ...
                        <div className="text-center" >
                            <h1 className="slideOutToRight p-0 m-0 font-ramona fs-2 p-sm-2">
                                ...
                                <span className="fw-bold text-uppercase">
                                     votre partenaire pour l'excellence, pour offrir des expériences uniques.
                                </span>
                                <br/>
                                <br/>
                                Comptabilité, administration, informatique, ressources humaines et marketing — des services professionnels pour optimiser votre performance
                            </h1>
                        </div>
                    </div>
                </div>
