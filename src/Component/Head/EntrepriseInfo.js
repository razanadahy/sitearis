                ...
                <div className="header-content p-0">
                    <div className="row w-100 m-0 p-0 text-white">
                        <div className="text-center" >
                            ...
                            >
                                <button onClick={null} type="button" className="btn mt-3 btn-style btn-lg p-4 rounded-4"  style={{ transition: 'background-color 700ms ease-in-out' }}>{t('brochure')}<i className="fa-solid fa-chevron-right ms-2"/></button>
                            </OverlayTrigger>
                        </div>
                    </div>
                </div>
