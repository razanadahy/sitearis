                ...
                <div className="card border-0 pt-4">
                    <div className="row">
                        ...
                        <div className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
                            {/*<div className="card h-100 border-0 mx-auto w-100">
                                <div className="card-body">
                                    <h3 className="text-center mb-3 px-3 text-info">Traitement d'image</h3>
                                    <div className="row">
                                        <p className="fs-5">
