            ...
            <div className="row m-0 p-4 w-100">
                <div className="card border-0 pt-4">
                    <div className="row m-0 p-0">
                        <div id={"compta"} className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
                        ...
                        <div id={'ext'} className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
                        ...
                        <div id={"traitement"} className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
                        ...
                        <div id={"rh"} className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
                        ...
                        <div id={"web"} className="col-lg-4 offset-lg-0 col-md-10 offset-md-1 col-sm-12 d-flex align-items-stretch mb-2">
