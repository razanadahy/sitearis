        ...
        <>
            <div className="w-100 m-0 p-3">
                ...
                <div className="mt-3 w-100 mb-2 p-0">
                    <DetailAvantage emplacement={0} image={unique} title={'Solutions personnalisées et unique'} text={'Chez Aris Concept, nous ne faisons pas dans le prêt-à-porter. Chaque solution est un produit unique, façonné à votre image. Bénéficiez d\'un accompagnement personnalisé pour des résultats qui sortent du lot.'}/>
                ...
                <div className="mt-2 w-100 mb-2 p-0">
                    ...
                    <DetailAvantage emplacement={1} image={flex} title={"Condition de travail au TOP"} text={"Chez Aris Concept, nous croyons que des collaborateurs épanouis sont la clé de notre succès. C'est pourquoi nous mettons tout en œuvre pour offrir un environnement de travail stimulant, où chacun peut s'épanouir et donner le meilleur de lui-même."}/>
                    <DetailAvantage emplacement={2} image={flex} title={"Equipement haute performance"} text={"Chez Aris Concept, nous croyons fermement que l'innovation passe par l'équipement haute performance. En investissant dans des technologies de pointe, nous offrons à notre équipe les outils nécessaires pour exceller dans leur travail et répondre aux besoins de nos clients avec efficacité."}/>
                    <DetailAvantage emplacement={3} image={stable} title={" Stabilité et engagement"} text={"Aris Concept, c'est l'assurance d'un partenariat durable. Notre entreprise, solidement implantée, vous offre une stabilité et un engagement à long terme, pour vous accompagner dans toutes les étapes de votre projet."}/>
                </div>
            </div>
        </>
    )
